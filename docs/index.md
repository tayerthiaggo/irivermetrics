...
HydroFragments `0.1.0` quantifies surface-water patch dynamics in intermittent river corridors from aligned water and valid-observation time series.

## Documentation Index

- **[Project Overview](project-overview.md):** Purpose, scope, capabilities, and scientific background.
...
- **[Performance & Scaling](performance.md):** Parallel execution, memory management, and benchmark results.
- **[Executive Overview](for-managers.md):** High-level summary of capabilities and applications.
