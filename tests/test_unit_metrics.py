"""Unit tests for irivermetrics.utils.calc_metrics helper functions."""
import numpy as np
import pandas as pd
import pytest
import xarray as xr

from irivermetrics.utils.calc_metrics import (
    batch_date_list,
